...
madai::PriorDistribution_RHIC_PCA::PriorDistribution_RHIC_PCA(madai::Model * in_Model){
  m_Model = in_Model;
...
double madai::PriorDistribution_RHIC_PCA::Evaluate(std::vector<double> Theta){
