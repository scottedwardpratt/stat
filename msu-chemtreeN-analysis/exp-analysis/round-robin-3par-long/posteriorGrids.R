...
compute.evidence <- function(grid){
  ...
  ## now we did the integral supposing that the total volume V = 1 (we didn't include the limits)
  ## so we'd be wrong if we weren't also multiplying by 1/V (the uniform prior) 
  ## 
