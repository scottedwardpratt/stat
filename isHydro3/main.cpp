...
void printDNs(CMesh* lMesh,int,int,int,parameterMap*);
...
/*
	  if (parameter::getB(*pMap,"HYDRO_BJORKEN"))  
	    fprintf(fEN,"%0.9g %0.9g\n", lMesh->getYL(i,nPrintX,nPrintY), pow(lMesh->getTau(),(4./3.)) * lMesh->getS(i,nPrintX,nPrintY,4));
	  else			
	    fprintf(fEN,"%0.9g %0.9g\n", lMesh->getYL(i,nPrintX,nPrintY), lMesh->getS(i,nPrintX,nPrintY,4));

	  fprintf(fEP, "%0.6g %0.6g\n", lMesh->getTau(), lMesh->integralEp(i));	
	  fprintf(fEZ, "%0.9g %0.9g\n", lMesh->getYL(i,nPrintX,nPrintY), lMesh->getS(i,nPrintX,nPrintY,4));
	  fprintf(fUz,"%0.9g %0.9g\n", lMesh->getYL(i,nPrintX,nPrintY), lMesh->getS(i,nPrintX,nPrintY,3));
  	  fprintf(fUzz,"%0.9g %0.9g\n", lMesh->getYL(i,nPrintX,nPrintY), lMesh->getS(i,nPrintX,nPrintY,3));

	  fprintf(fA1z,"%0.9g %0.9g\n", lMesh->getYL(i,nPrintX,nPrintY), lMesh->getS(i,nPrintX,nPrintY,5));
	  fprintf(fA2z,"%0.9g %0.9g\n", lMesh->getYL(i,nPrintX,nPrintY), lMesh->getS(i,nPrintX,nPrintY,6));
	  fprintf(fA3z,"%0.9g %0.9g\n", lMesh->getYL(i,nPrintX,nPrintY), lMesh->getS(i,nPrintX,nPrintY,7));
	  fprintf(fA4z,"%0.9g %0.9g\n", lMesh->getYL(i,nPrintX,nPrintY), lMesh->getS(i,nPrintX,nPrintY,8));
	  fprintf(fA5z,"%0.9g %0.9g\n", lMesh->getYL(i,nPrintX,nPrintY), lMesh->getS(i,nPrintX,nPrintY,9));
	  fprintf(fBz, "%0.9g %0.9g\n", lMesh->getYL(i,nPrintX,nPrintY), lMesh->getS(i,nPrintX,nPrintY,10));

	  fprintf(fT,"%0.9g %0.9g\n", lMesh->getYL(i,nPrintX,nPrintY), lMesh->getT(i,nPrintX,nPrintY));
	  fprintf(fP,"%0.9g %0.9g\n", lMesh->getYL(i,nPrintX,nPrintY), lMesh->getP(i,nPrintX,nPrintY));
	  fprintf(fTxx,"%0.9g %0.9g\n", lMesh->getYL(i,nPrintX,nPrintY),lMesh->getTxyMesh(i,nPrintX,nPrintY,1,1));
	  fprintf(fTyy,"%0.9g %0.9g\n", lMesh->getYL(i,nPrintX,nPrintY),lMesh->getTxyMesh(i,nPrintX,nPrintY,2,2));
	  fprintf(fTzz,"%0.9g %0.9g\n", lMesh->getYL(i,nPrintX,nPrintY),lMesh->getTxyMesh(i,nPrintX,nPrintY,3,3));
	  fprintf(fTxy,"%0.9g %0.9g\n", lMesh->getYL(i,nPrintX,nPrintY),lMesh->getTxyMesh(i,nPrintX,nPrintY,1,2));
	  fprintf(fTyz,"%0.9g %0.9g\n", lMesh->getYL(i,nPrintX,nPrintY),lMesh->getTxyMesh(i,nPrintX,nPrintY,2,3));
...
*/
	  ...
	  fprintf(fEP, "%0.6g %0.6g\n", lMesh->getTau(), lMesh->integralEp(i));	
	  fprintf(fEZ, "%0.9g %0.9g\n", mDn*i, lMesh->getS(i,nPrintX,nPrintY,4));
	  fprintf(fUz,"%0.9g %0.9g\n", mDn*i, lMesh->getS(i,nPrintX,nPrintY,3));
  	  fprintf(fUzz,"%0.9g %0.9g\n", mDn*i, lMesh->getS(i,nPrintX,nPrintY,3));

	  fprintf(fA1z,"%0.9g %0.9g\n", mDn*i, lMesh->getS(i,nPrintX,nPrintY,5));
	  fprintf(fA2z,"%0.9g %0.9g\n", mDn*i, lMesh->getS(i,nPrintX,nPrintY,6));
	  fprintf(fA3z,"%0.9g %0.9g\n", mDn*i, lMesh->getS(i,nPrintX,nPrintY,7));
	  fprintf(fA4z,"%0.9g %0.9g\n", mDn*i, lMesh->getS(i,nPrintX,nPrintY,8));
	  fprintf(fA5z,"%0.9g %0.9g\n", mDn*i, lMesh->getS(i,nPrintX,nPrintY,9));
	  fprintf(fBz, "%0.9g %0.9g\n", mDn*i, lMesh->getS(i,nPrintX,nPrintY,10));

	  fprintf(fT,"%0.9g %0.9g\n", mDn*i, lMesh->getT(i,nPrintX,nPrintY));
	  fprintf(fP,"%0.9g %0.9g\n", mDn*i, lMesh->getP(i,nPrintX,nPrintY));
	  fprintf(fTxx,"%0.9g %0.9g\n", mDn*i,lMesh->getTxyMesh(i,nPrintX,nPrintY,1,1));
	  fprintf(fTyy,"%0.9g %0.9g\n", mDn*i,lMesh->getTxyMesh(i,nPrintX,nPrintY,2,2));
	  fprintf(fTzz,"%0.9g %0.9g\n", mDn*i,lMesh->getTxyMesh(i,nPrintX,nPrintY,3,3));
	  fprintf(fTxy,"%0.9g %0.9g\n", mDn*i,lMesh->getTxyMesh(i,nPrintX,nPrintY,1,2));
	  fprintf(fTyz,"%0.9g %0.9g\n", mDn*i,lMesh->getTxyMesh(i,nPrintX,nPrintY,2,3));

//	  fprintf(fTIS, "%0.9g %0.9g\n", mDn*i, lMesh->getTIS(i,nPrintX,nPrintY));
//	  fprintf(fTISB,"%0.9g %0.9g\n", mDn*i, lMesh->getTISB(i,nPrintX,nPrintY));
	}
	...
	for (int i=0;i<lMesh->getXSize();i++) {
	  ...
	  fprintf(fU0,"%0.9g %0.9g\n", mDx*i, lMesh->getS(lPrintN,i,lPrintY,0));
	  fprintf(fUx,"%0.9g %0.9g\n", mDx*i, lMesh->getS(lPrintN,i,lPrintY,1));

	  fprintf(fA1x,"%0.9g %0.9g\n", mDx*i, lMesh->getS(lPrintN,i,lPrintY,5));
	  fprintf(fA2x,"%0.9g %0.9g\n", mDx*i, lMesh->getS(lPrintN,i,lPrintY,6));
	  fprintf(fA3x,"%0.9g %0.9g\n", mDx*i, lMesh->getS(lPrintN,i,lPrintY,7));
	  fprintf(fA4x,"%0.9g %0.9g\n", mDx*i, lMesh->getS(lPrintN,i,lPrintY,8));
	  fprintf(fA5x,"%0.9g %0.9g\n", mDx*i, lMesh->getS(lPrintN,i,lPrintY,9));
	  fprintf(fBx, "%0.9g %0.9g\n", mDx*i, lMesh->getS(lPrintN,i,lPrintY,10));

	  double P = lMesh->getP(lPrintN,i,lPrintY);
	  fprintf(fT,"%0.9g %0.9g\n", mDx*i, lMesh->getT(lPrintN,i,lPrintY));
	  fprintf(fP,"%0.9g %0.9g\n", mDx*i, P);

	  fprintf(fTxx,"%0.9g %0.9g\n", mDx*i, lMesh->getPixyMesh(lPrintN,i,lPrintY,1,1)/P);
	  fprintf(fTrr,"%0.9g %0.9g\n", mDx*i, lMesh->getTRR(lPrintN,i,lPrintY)/P);
	  fprintf(fTpp,"%0.9g %0.9g\n", mDx*i, lMesh->getTPhiPhi(lPrintN,i,lPrintY)/P);
	  fprintf(fTpr,"%0.9g %0.9g\n", mDx*i, lMesh->getTRPhi(lPrintN,i,lPrintY)/P);

	  fprintf(fTxxNS,"%0.9g %0.9g\n",mDx*i, lMesh->getPixyNS(lPrintN,i,lPrintY,1,1)/P);
	  fprintf(fTyy,"%0.9g %0.9g\n",  mDx*i, lMesh->getPixyMesh(lPrintN,i,lPrintY,2,2)/P);
	  fprintf(fTzz,"%0.9g %0.9g\n",  mDx*i, lMesh->getPixyMesh(lPrintN,i,lPrintY,3,3)/P);
	...
	for (int i=-1;i<=lMesh->getYSize();i++) {
	  fprintf(fEY, "%0.9g %0.9g\n", mDy*i, lMesh->getS(mPrintN,mPrintX,i,4));
		
	  fprintf(fUy, "%0.9g %0.9g\n", mDy*i,lMesh->getS(mPrintN,mPrintX,i,2));
	  
	  fprintf(fA1y,"%0.9g %0.9g\n", mDy*i, lMesh->getS(mPrintN,mPrintX,i,5));
	  fprintf(fA2y,"%0.9g %0.9g\n", mDy*i, lMesh->getS(mPrintN,mPrintX,i,6));
	  fprintf(fA3y,"%0.9g %0.9g\n", mDy*i, lMesh->getS(mPrintN,mPrintX,i,7));
	  fprintf(fA4y,"%0.9g %0.9g\n", mDy*i, lMesh->getS(mPrintN,mPrintX,i,8));
	  fprintf(fA5y,"%0.9g %0.9g\n", mDy*i, lMesh->getS(mPrintN,mPrintX,i,9));
	  fprintf(fBy, "%0.9g %0.9g\n", mDy*i, lMesh->getS(mPrintN,mPrintX,i,10));
	
//	  double P = lMesh->getP(mPrintN,mPrintX,i);
//	  fprintf(fT,"%0.9g %0.9g\n", mDy*i, lMesh->getT(mPrintN,mPrintX,i));
//	  fprintf(fP,"%0.9g %0.9g\n", mDy*i, P);
	  
//	  fprintf(fTxx,"%0.9g %0.9g\n", mDy*i, lMesh->getPixyMesh(mPrintN,mPrintX,i,1,1)/P);
//	  fprintf(fTyy,"%0.9g %0.9g\n", mDy*i, lMesh->getPixyMesh(mPrintN,mPrintX,i,2,2)/P);
//	  fprintf(fTzz,"%0.9g %0.9g\n", mDy*i, lMesh->getPixyMesh(mPrintN,mPrintX,i,3,3)/P);
	}

	for (int i=0;i<= min(lMesh->getYSize(),lMesh->getXSize());i++) {
	  double P = lMesh->getP(lPrintN,i,i);
	  fprintf(fTxy,"%0.9g %0.9g\n", ROOT2*mDx*(double) i, lMesh->getPixy(lPrintN,i,i,1,2)/P);
	  fprintf(fTyz,"%0.9g %0.9g\n", ROOT2*mDx*(double) i, lMesh->getPixy(lPrintN,i,i,2,3)/P);
	  fprintf(fU0 ,"%0.9g %0.9g\n", ROOT2*mDx*(double) i, lMesh->getS(lPrintN,i,i,0));
	  
      fprintf(fTrr,"%0.9g %0.9g\n",ROOT2*mDx*i, lMesh->getTRR(lPrintN,i,i)/P);
	  fprintf(fTpp,"%0.9g %0.9g\n",ROOT2*mDx*i, lMesh->getTPhiPhi(lPrintN,i,i)/P);
...
void printDNs(CMesh* lMesh,int mNSize, int mXSize, int mYSize, parameterMap* pMap) {
